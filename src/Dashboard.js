    ...
    plugins: {
      legend: {
        labels: {
          ...
          color: '#333', // Darker text color for legends
        },
      },
    },
    scales: {
      x: {
        ticks: {
          ...
          color: '#333', // Darker text color for x-axis
        },
        title: {
          display: true,
          text: 'Month',
          ...
          color: '#333', // Darker text color for x-axis title
        },
      },
      y: {
        ticks: {
          ...
          color: '#333', // Darker text color for y-axis
        },
        title: {
          display: true,
          text: 'Amount',
          ...
          color: '#333', // Darker text color for y-axis title
        },
      },
    },
  };
